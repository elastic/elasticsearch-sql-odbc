...
- *64 bit driver (x64)* for use with all other applications (recommended).
...
If you encounter an error during installation we would encourage you to open an issue https://github.com/elastic/elasticsearch-sql-odbc/issues, attach your installation log file and provide details so we can investigate.
